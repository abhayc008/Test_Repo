    			    ...
    			    success:function(result)
    			     {
    				   ...
    				   $("#custemailiderr").removeClass();
    				   var className = (result.toUpperCase().indexOf(('not').toUpperCase()) != -1) ? 'text-success font-weight-bold' : 'text-danger font-weight-bold';
    				   $("#custemailiderr").addClass(className);
    			     },
            ...
            <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    ...
                    <span class="text-danger font-weight-bold" id="custemailiderr"></span>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-6">
