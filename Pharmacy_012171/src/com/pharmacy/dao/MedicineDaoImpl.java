...
public class MedicineDaoImpl implements MedicineDao 
{
    ...
    String addMed = "insert into medicine_012171(medicine_name,medicine_type,medicine_brand,"
    		+ "medicine_discription,medicine_qty,mfg_date,expiry_date,medicine_price) values(?,?,?,?,?,?,?,?)";

	String updateMed = "update  medicine_012171 set  medicine_name=?,medicine_type=?,medicine_brand=?,  medicine_discription=?,"
			+ "medicine_qty=?,mfg_date=?,expiry_date=?,medicine_price=? where medicine_id=? ";
	
	String deleteMed = "delete from medicine_012171 where medicine_id = ?";
	...
	public List<Medicine> searchMedicineByMedicineName(String medicineName)
	{
	    ...
	    try 
	    {
	    	  String searchByName = "Select * from medicine_012171 where medicine_name  like  '%"+medicineName+"%'";
