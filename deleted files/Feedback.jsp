    	 ...
    	 $("#feedback_form").validate({
    		 ...
    		 messages: {
    			     ...
    			     rateus: "Please select any number "
    	  		    ...
    	  		    $.ajax({
    	 			    type:'GET',
    	 			    data:{name:'checkmedicinename',medname:''},
    	 			    url:'MedicineServlet',
    	 			    success:function(result)
    	 			     {
    	 			    	var availableMeds = new Array();
    	 			    	$.each(result, function(key, value) {
    	 			    	    
    	 			    	    console.log(value.medicineName);
    	 			    	   availableMeds.push(value.medicineName);
            ...
            <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <span class="rext-danger font-weight-bold" id="mednameerror"></span><b></b>
                  </div>
                  <div class="col-md-6">
                    ...
                    <div class="form-group" id="rating-ability-wrapper">
	                    ...
	                    <span class="field-label-header">Rate medicine between 1 to 10:<span class="text-danger">*</span></label></span><br>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="service" class="text-black">Rate our service between 1 to 10:<span class="text-danger">*</span></label>
                    <select class="form-control" id="rateus" name="rateus"  >
